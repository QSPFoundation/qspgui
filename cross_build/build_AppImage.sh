...
BUILD_DIR=/work/cross_build/linux64_AppImage

cmake -S /work -B $BUILD_DIR -DAPP_VERSION="$APP_VERSION" -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_BUILD_TYPE=Release
...
LIB_PATH=$(find $BUILD_DIR/AppDir -type d -printf ":%p")
